...
import "../Dashboard/profileManagement.css";
  ...
  useEffect(() => {
    const fetchUserProfile = async () => {
      try {
        ...
        setProfile({
          fullName: `${userData.first_name || ''} ${userData.last_name || ''}`.trim() || user?.email?.split('@')[0] || 'Admin',
...
const onChangePassword = async (e) => {
  ...
  return (
    <div className="pm-wrap" style={{ padding: '0px', width: '100%', maxWidth: 'none' }}>
      ...
      <div className="pm-grid" style={{ gridTemplateColumns: 'minmax(300px, 360px) 1fr' }}>
        {/* LEFT: Profile card */}
        <section className="pm-card pm-left">
          ...
          <div className="pm-mini">
            <div className="pm-miniLabel">Role</div>
            <div className="pm-miniValue">{"Admin"}</div>
          </div>
        ...
        <section className="pm-right">
          ...
          <form className="pm-card" onSubmit={onSaveProfile}>
            ...
            <div className="pm-actions">
              ...
              <button className="pm-btn pm-btnGhost" type="button" onClick={() => window.location.reload()}>
                Cancel
              </button>
            </div>
          </form>
